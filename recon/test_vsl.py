...
MODEL_DIRECTORY = './data/results/models/recon/'
...
parser.add_argument('-eid', '--experiment-id', type=str, default='best_vsl_model.pth.tar')
...
model = models_vsl.VSLModel(args=args)
model = model.cuda()

state_dicts = torch.load('~/SoftRas/data/results/models/recon/best_vsl_model.pth.tar')
